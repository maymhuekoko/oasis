                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="text-overflow: ellipsis; white-space: nowrap;" class="text-center">
                                    ...
                                    <a href="{{route('unbrake_status',$unit->id)}}" class="btn btn-sm btn-danger rounded">Unbrake</a>
                                    @else
                                    <a href="{{route('brake_status',$unit->id)}}" class="btn btn-sm btn-success rounded">Brake</a>
                                    @endif

                                    <a href="#" class="btn btn-sm btn-warning rounded" data-toggle="modal" data-target="#edit_item{{$unit->id}}">
                                    Edit</a>

                                    {{-- <a href="{{route('edit_unit_ingredient', $unit->id)}}" class="btn btn-secondary">
                                    Edit Ingredients</a> --}}

                                    <a href="#" class="btn btn-sm btn-danger rounded" onclick="ApproveLeave('{{$unit->id}}')">
